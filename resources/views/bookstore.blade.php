...
@section('content')
@include('includes.bookstore.book_slider') 
...
<div class="wantToWork-area w-padding2 mb-30" data-background="book_assets/img/gallery/wants-bg1.jpg">
...
<div class="col-xl-6 col-lg-6">
<div class="wantToWork-area w-padding2 mb-30" data-background="book_assets/img/gallery/wants-bg2.jpg">
<h2>Wilma Mumduya</h2>
<div class="linking">
<a href="#" class="btn wantToWork-btn">View Details</a>
</div>
...
<div class="container">
<div class="subscribe-caption text-center  subscribe-padding section-img2-bg" data-background="book_assets/img/gallery/section-bg1.jpg">
<div class="row justify-content-center">
