...
<div class="content">
    <div class="animated fadeIn">
        <div class="container">
            <div class="row"><div class="col-md-12"><h1 style="text-align: center;"></h1></div></div>
                            ...
                            <div class = "modal-dialog" role = "document">
                                <div class = "modal-content">
                                    ...
                                    <div class = "modal-body">
                                        <form role="form" action="#"  accept-charset="UTF-8"    method="post" enctype="multipart/form-data" >
                                            @csrf 
